...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Promptly is model-agnostic. We support all models, including the very latest, from OpenAI (GPT-4, GPT-5 and others), all models Anthropic (Claude 4.5 Haiku, 4.6 Sonnet and 4.6 Opus), Google Gemini, Grok other LLMs supported by Vercel's AI SDK.",
  },
  {
