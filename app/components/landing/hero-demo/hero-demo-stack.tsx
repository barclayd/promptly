...
export const HeroDemoStack = ({ className }: HeroDemoStackProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[400px] sm:h-[380px] lg:h-[360px] w-full flex items-start justify-center pt-12 overflow-hidden">
        {windows.map((window, index) => {
          ...
          return (
            <div
              key={window.id}
              className="absolute w-[min(420px,85vw)] max-h-[365px] sm:max-h-[345px] lg:max-h-[325px] transition-all duration-500 ease-out"
