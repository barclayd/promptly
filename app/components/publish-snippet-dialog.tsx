...
export const PublishSnippetDialog = ({
  children,
  snippetId,
  suggestedVersion,
  lastPublishedVersion,
  disabled,
}: PublishSnippetDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <fetcher.Form method="post" action="/api/snippets/publish">
          <input type="hidden" name="snippetId" value={snippetId} />
          <input type="hidden" name="version" value={version} />
          <DialogHeader>
            <DialogTitle>Publish version</DialogTitle>
            <DialogDescription>
              Publishing makes this version available for use in prompts.
            </DialogDescription>
          </DialogHeader>
          <div className="py-6">
