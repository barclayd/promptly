/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 73c50719ac5c143cc705afd1e87a7d06)
// Runtime types generated with workerd@1.20260911.1 2025-10-08 global_fetch_strictly_public,nodejs_compat_v2
interface __BaseEnv_Env {
	...
	MCP_ENABLED: string;
	MCP_PILOT_WORKSPACES: string;
	MCP_ALLOW_DCR: string;
	PRESENCE_ROOM: DurableObjectNamespace<import("./workers/app").PresenceRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "PresenceRoom";
	}
